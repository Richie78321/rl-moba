...
class TestPBTAgent(PBTAgent):
  ...
  def update_hyperparams(self, hyperparams_changed, evoke_update_event: bool = False):
...
pbt_update_all(list(zip(agents, rewards, [True] * len(agents))), 
  exploit_methods={
    'param1': lambda x: x,
    'param2': lambda x: x,
  }, 
  explore_methods={
    ...
    'param2': get_discrete_perturb_explore(),
  },
  exploit_portion=0.5)